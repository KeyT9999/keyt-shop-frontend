  ...
  return (
    <div className="product-detail-page">
      ...
      <div className="product-detail-container">
        {/* Product Info - Will appear first on mobile */}
        ...
        {/* Product Image - Will appear second on mobile */}
        ...
        {/* Product Options - Shows below images on mobile */}
        {product.options && product.options.length > 0 && (
          <div className="subscription-section">
            <h3 className="section-title">CHỌN GÓI SẢN PHẨM</h3>
