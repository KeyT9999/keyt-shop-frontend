...
import Upload from '../components/PhotoFrame/ui/Upload';
import TemplateSelector from '../components/PhotoFrame/ui/TemplateSelector';
import FrameCanvas from '../components/PhotoFrame/ui/FrameCanvas';
import { extractExif } from '../utils/photoframe/extractExif';
import { iphoneFrame } from '../components/PhotoFrame/templates/iphoneFrame';
import { Image as ImageIcon, Download, X, Moon, Sun, LayoutTemplate, SlidersHorizontal, Type, ArrowDownToLine } from 'lucide-react';
import { generateFrameUrl } from '../utils/photoframe/generateFrame';

// Import logos
import appleLogo from '../assets/photoframe/Apple_logo_black.svg.png';
import fujiLogo from '../assets/photoframe/Fujifilm_logo.svg.png';
import fujiLogoWhite from '../assets/photoframe/Fujifilm-Logo-WHITE.png';
import sonyLogo from '../assets/photoframe/Sony_logo.svg.png';
import canonLogo from '../assets/photoframe/Canon_wordmark.svg.png';
import nikonLogo from '../assets/photoframe/Nikon_logo.png';
...
import '../components/PhotoFrame/styles.css';
...
export default function PhotoFramePage() {
  ...
  return (
    <div className={`photo-frame-page app-container${isDarkMode ? ' dark-theme' : ''}`}>
      {isProcessingUpload && (
